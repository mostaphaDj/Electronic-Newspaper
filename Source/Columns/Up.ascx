<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Up.ascx.cs" Inherits="ElMestakbal.Columns.Up" %>

<div class="up" style="margin-bottom:12px;">
    ...
    <asp:HyperLink ID="HyperLinkLogo" runat="server">
        <img class="upDirection" src="/Columns/Images/up.png" width="70px" style="position:absolute;" />
    </asp:HyperLink>
