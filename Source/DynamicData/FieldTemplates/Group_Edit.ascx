<%@ Control Language="C#" CodeBehind="Group_Edit.ascx.cs" Inherits="ElMestakbal.DynamicData.FieldTemplates.Group_EditField" %>
...
<asp:EntityDataSource ID="EntityDataSource1" runat="server" 
    ...
    EnableFlattening="False" EntitySetName="Groups" Select="it.[Id], it.[Name]">
