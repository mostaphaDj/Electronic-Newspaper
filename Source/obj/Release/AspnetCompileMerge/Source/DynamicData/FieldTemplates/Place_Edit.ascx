<%@ Control Language="C#" CodeBehind="Place_Edit.ascx.cs" Inherits="ElMestakbal.DynamicData.FieldTemplates.Place_EditField" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>


<telerik:RadComboBox ID="RadComboBox1" runat="server" selectedvalue='<%# FieldValue %>' EmptyMessage=" "
        DataSourceID="EntityDataSource1" DataTextField="Name" 
    DataValueField="Id" ondatabound="RadComboBox1_DataBound"   >
</telerik:RadComboBox>

<asp:EntityDataSource ID="EntityDataSource1" runat="server" 
    ConnectionString="name=NewsDBEntities" DefaultContainerName="NewsDBEntities" 
    EnableFlattening="False" EntitySetName="Places" Select="it.[Id], it.[Name]">
